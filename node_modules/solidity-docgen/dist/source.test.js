...
ava_1.default('contracts in scope from imported files', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .file('Bar.sol')
...
ava_1.default('contracts in scope from imported files with alias', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .file('Bar.sol')
...
ava_1.default('contracts in scope from imported files transitively', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .file('Bar.sol')
...
ava_1.default('using real compiler output (0.6)', async (t) => {
  ...
  `;
    const solcOutput = await solc_fork_1.solcCompile('solc', {
        language: 'Solidity',
        sources: {
            test: {
                content: sourceText,
